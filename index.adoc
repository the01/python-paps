...
and start developing without any difficulties. This is further aided by the python
programming language, which, except for a few peculiarities, allows for a straight
forward way to write code. +
...
Pi and sensors consists mostly of resistors, it should be constructable for little
money too.
