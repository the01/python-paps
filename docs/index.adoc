...
== Source Code
=== PAPS
Core framework for audience participation

https://github.com/the01/python-paps



=== Settings
PAPS plugin to configure and control other PAPS plugins from a browser

https://github.com/the01/paps-settings



=== Soundmix
PAPS plugin implementing the described audience interaction allowing the user to
create interactive musical performances.

https://github.com/the01/paps-soundmix
